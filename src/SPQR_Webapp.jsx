...
function CharacterPanel({user,onUpdate}){
  ...
  useEffect(()=>{
    ...
    setIdentity({latinName:user.latinName||"",username:user.username||"",charClass:user.charClass||"Patrician",discord:user.discord||""});
  ...
  const saveIdentity=async()=>{
    ...
    const updatedUser={...user,latinName,username,charClass:identity.charClass||"Patrician",discord};
