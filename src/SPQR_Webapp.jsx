...
function PlayerApp({user:initUser,onLogout}){
  ...
  const GROUPS=[
    {key:"gov",label:"🏛️ Government",tone:"gov",tabs:[
      {k:"senate",l:"Senate"},{k:"voting",l:`Motions${votingCount>0?` (${votingCount})`:""}`},{k:"orders",l:"Orders"},{k:"resources",l:"Resources"},{k:"legions",l:"Legions"},{k:"magistrates",l:"Magistrates"},{k:"courts",l:"Courts"},{k:"elections",l:"Elections"},...(pos?[{k:"office",l:`${pos.abbr}`,tone:"office"}]:[])
    ]},
