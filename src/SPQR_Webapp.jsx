...
.spqr-login-mode-btn.active{background:var(--gold);color:#1a0800}
.spqr-login-mode-btn:not(.active){background:transparent;color:rgba(255,249,238,.45)}
  ...
  return(
    <div style={{minHeight:"100vh",background:T.bg,borderTop:`3px solid ${T.red}`}}>
      ...
      <div className="spqr-topbar" style={{background:pos?`linear-gradient(135deg,${officeBg}88,#0D0804)`:"linear-gradient(135deg,#0D0804,#1A0E08)",borderBottom:`2px solid ${pos?officeAccent:T.red}`}}>
        ...
        <Row gap=".45rem" style={{display:"none"}} className="spqr-mobile-topbar-right">
          <NotifBell userId={user.id}/>
        </Row>
      </div>
